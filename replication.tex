...
\section*{Graphs Replication}

\underline{\textbf{This cannot be ran until ALL algorithms (Excluding 6) have been ran with 50 repetitions.}}

\begin{verbatim}
(venv) python graphs.py --folder=results_replicated --output=graphs/f1_replicated.pdf
\end{verbatim}

Use either the original \texttt{results} folder or the new \texttt{results\_replicated} folder to generate the graphs, and specify the output file name for the generated PDF.\\
The generated graphs will be saved in the specified output file.


\section*{Hypothesis Testing Replication}

\underline{\textbf{This cannot be ran until ALL algorithms (Excluding 6) have been ran with 50 repetitions.}}

\begin{verbatim}
(venv) python hypothesis.py --folder=results_replicated
\end{verbatim}

Use either the original \texttt{results} folder or the new \texttt{results\_replicated} folder to generate the hypothesis test results.
